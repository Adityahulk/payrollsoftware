...
public interface ISalaryRepository
{
    ...
    Task CreatePayslipDirectAsync(int empId, int spaceId, decimal baseAmount, decimal deduction, decimal finalAmount, int paymentId, decimal basic, decimal totalAllowance, string breakdown, string paymentMethod, string transactionId);
}
