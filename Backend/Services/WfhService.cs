...
namespace Backend.Services
{
    ...
    public class WfhService : IWfhService
    {
        ...
        {
            // Allow loopback and local intranet subnets (dev convience)
            ...
            // Check if there is an active same-day WFH permit
            return await IsWfhAllowedAsync(empId, DateTime.Today);
        }
