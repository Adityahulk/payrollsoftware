...
namespace Backend.Services
{
    ...
    public class LeaveService : ILeaveService
    {
        ...
        public async Task<bool> UpdateLeaveStatusAsync(int leaveId, string status, int approvedByEmpId, int callerSpaceId, string callerRole)
        {
            ...
            // We should check that the leave record belongs to the caller's spaceId
            // A simple implementation retrieves leaves, but repository handles space scoping based on caller parameters
